...
CumulMeanPr<-function(file,latUTM,lonUTM,AnnoInizio,AnnoFine){
...
#MonthsINyears<-matrix(ncvar_get(pr7600,"pr")[longa,lata,fugaceMomento],nrow=12,byrow=FALSE)
...
MonthsINyears<-matrix(unlist(lapply(X=seq(1,length(fugaceMomento)),FUN=milmetMese)),nrow=12,byrow=TRUE)
